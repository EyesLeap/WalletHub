...
export interface CompanyBalanceSheet {
  ...
  othertotalCurrencyholdersEquity: number;
  totalCurrencyholdersEquity: number;
  totalEquity: number;
  totalLiabilitiesAndCurrencyholdersEquity: number;
...
export interface CompanyCashFlow {
  ...
  currencyBasedCompensation: number;
  ...
  commonCurrencyIssued: number;
  commonCurrencyRepurchased: number;
...
export interface CompanyKeyMetrics {
  ...
  currencyBasedCompensationToRevenueTTM: number;
