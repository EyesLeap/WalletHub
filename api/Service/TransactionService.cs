...
namespace api.Service
{
    public class TransactionService : ITransactionService
    {
        ...
        { 
            ...
            var apiCurrency = await _cmpService.FindCurrencyBySymbolAsync(dto.Symbol);
            if (apiCurrency == null) 
                return null;
            ...
            if (asset == null && dto.TransactionType == TransactionType.Buy) 
                asset = await CreateAsset(apiCurrency, portfolioId, dto);

            bool success = await ProcessTransactionAsync(asset, apiCurrency, portfolioId, dto);
        ...
        private async Task<Asset> CreateAsset(MarketCurrency apiCurrency, int portfolioId, CreateTransactionDto dto)
        {
        ...
        private async Task<bool> ProcessTransactionAsync(Asset asset, MarketCurrency apiCurrency, int portfolioId, CreateTransactionDto dto)
        {
